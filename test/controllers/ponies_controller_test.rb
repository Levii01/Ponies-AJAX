...
class PoniesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pony" do
    assert_difference('Pony.count') do
      post ponies_url, params: { pony: { cutie_mark: @pony.cutie_mark, name: @pony.name, profession: @pony.profession } }
    end
  ...
  test "should update pony" do
    patch pony_url(@pony), params: { pony: { cutie_mark: @pony.cutie_mark, name: @pony.name, profession: @pony.profession } }
